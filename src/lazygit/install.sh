...
set -o nounset
set -o allexport
readonly githubRepository='jesseduffield/lazygit'
readonly binaryName='lazygit'
...
install() {
    ...
    readonly downloadUrlTemplate='https://github.com/${githubRepository}/releases/download/${releaseTag}/lazygit_${version}_Linux_${architecture}.tar.gz'
