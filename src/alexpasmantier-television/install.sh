...
set -o nounset
set -o allexport
readonly githubRepository='alexpasmantier/television'
readonly binaryName='tv'
readonly versionArgument='--version'
readonly downloadUrlTemplate='https://github.com/${githubRepository}/releases/download/${releaseTag}/tv-${releaseTag}-${architecture}-unknown-linux-gnu.tar.gz'
