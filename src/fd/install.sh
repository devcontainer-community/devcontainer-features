...
set -o nounset
set -o allexport
readonly githubRepository='sharkdp/fd'
readonly binaryName='fd'
...
install() {
    ...
    readonly downloadUrlTemplate='https://github.com/${githubRepository}/releases/download/${releaseTag}/fd-${releaseTag}-${architecture}-unknown-linux-musl.tar.gz'
