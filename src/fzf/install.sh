...
set -o nounset
set -o allexport
readonly githubRepository='junegunn/fzf'
readonly binaryName='fzf'
...
install() {
    ...
    readonly downloadUrlTemplate='https://github.com/${githubRepository}/releases/download/${releaseTag}/fzf-${version}-linux_${architecture}.tar.gz'
