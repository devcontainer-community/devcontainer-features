...
set -o nounset
set -o allexport
readonly githubRepository='derailed/k9s'
readonly binaryName='k9s'
...
install() {
    ...
    readonly downloadUrlTemplate='https://github.com/${githubRepository}/releases/download/${releaseTag}/k9s_Linux_${architecture}.tar.gz'
