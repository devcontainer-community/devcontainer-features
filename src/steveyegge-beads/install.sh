...
set -o nounset
set -o allexport
readonly githubRepository='steveyegge/beads'
readonly binaryName='bd'
readonly downloadUrlTemplate='https://github.com/${githubRepository}/releases/download/${releaseTag}/beads_${version}_linux_${architecture}.tar.gz'
