...
set -o nounset
set -o allexport
readonly githubRepository='pulumi/pulumi'
readonly binaryName='pulumi'
readonly binaryTargetFolder='/usr/local/bin'
readonly downloadUrlTemplate='https://github.com/${githubRepository}/releases/download/${releaseTag}/${name}-${releaseTag}-linux-${architecture}.tar.gz'
