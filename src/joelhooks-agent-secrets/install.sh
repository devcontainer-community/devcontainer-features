...
set -o nounset
set -o allexport
readonly githubRepository='joelhooks/agent-secrets'
readonly binaryName='secrets'
...
install() {
    ...
    readonly downloadUrlTemplate='https://github.com/${githubRepository}/releases/download/${releaseTag}/agent-secrets_${version}_linux_${architecture}.tar.gz'
