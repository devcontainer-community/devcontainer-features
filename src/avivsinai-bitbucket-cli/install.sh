...
set -o nounset
set -o allexport
readonly githubRepository='avivsinai/bitbucket-cli'
readonly binaryName='bkt'
...
install() {
    ...
    readonly downloadUrlTemplate='https://github.com/${githubRepository}/releases/download/${releaseTag}/bkt_${version}_linux_${architecture}.tar.gz'
