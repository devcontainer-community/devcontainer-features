...
set -o nounset
set -o allexport
readonly githubRepository='sharkdp/bat'
readonly binaryName='bat'
...
install() {
    ...
    readonly downloadUrlTemplate='https://github.com/${githubRepository}/releases/download/${releaseTag}/bat-${releaseTag}-${architecture}-unknown-linux-musl.tar.gz'
