...
set -o nounset
set -o allexport
readonly githubRepository='biomejs/biome'
readonly binaryName='biome'
...
install() {
    ...
    readonly downloadUrl="https://github.com/${githubRepository}/releases/download/${releaseTag}/${binaryName}-linux-${architecture}"
